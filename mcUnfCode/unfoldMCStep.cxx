...
void unfold(bool doPrompt = true, bool doMid = true, Int_t iterMax = 8, Int_t stepNumber = 1) {
  ...
  if(doPrompt && doMid){
    testInputName = Form("optUnf/unfInput/step%i/response_4D_prompt_midRapidity_Test.root",stepNumber);
    trainInputName = Form("optUnf/unfInput/step%i/response_4D_prompt_midRapidity_Train.root",stepNumber);
    outputName = Form("optUnf/unfOutput/step%i/UnfoldedDistributions_Prompt_Mid_8iter.root",stepNumber);
  }
  if(doPrompt && !doMid){
    testInputName = Form("optUnf/unfInput/step%i/response_4D_prompt_fwdRapidity_Test.root",stepNumber);
    trainInputName = Form("optUnf/unfInput/step%i/response_4D_prompt_fwdRapidity_Train.root",stepNumber);
    outputName = Form("optUnf/unfOutput/step%i/UnfoldedDistributions_Prompt_Fwd_8iter.root",stepNumber);
  }
    
  if(!doPrompt && doMid){
    testInputName = Form("optUnf/unfInput/step%i/response_4D_nonprompt_midRapidity_Test.root",stepNumber);
    trainInputName = Form("optUnf/unfInput/step%i/response_4D_nonprompt_midRapidity_Train.root",stepNumber);
    outputName = Form("optUnf/unfOutput/step%i/UnfoldedDistributions_NonPrompt_Mid_8iter.root",stepNumber);
  }
  if(!doPrompt && !doMid){
    testInputName = Form("optUnf/unfInput/step%i/response_4D_nonprompt_fwdRapidity_Test.root",stepNumber);
    trainInputName = Form("optUnf/unfInput/step%i/response_4D_nonprompt_fwdRapidity_Train.root",stepNumber);
    outputName = Form("optUnf/unfOutput/step%i/UnfoldedDistributions_NonPrompt_Fwd_8iter.root",stepNumber);
  }
...
void unfoldMCStep(Int_t step = 1){
